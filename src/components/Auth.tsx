      ...
      >
        ...
        <div className="glass-card rounded-[2.5rem] p-8 space-y-6">
          ...
          <form className="space-y-4" onSubmit={(e) => { 
            ...
            <button 
              type="button"
              onClick={() => onLogin('', '', true, referralCode, 'GOOGLE')}
              className="w-full bg-white/5 hover:bg-white/10 text-white font-bold py-4 rounded-2xl transition-all border border-white/10 active:scale-95 flex items-center justify-center gap-3"
            >
